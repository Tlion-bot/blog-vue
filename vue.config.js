...
const name = process.env.VUE_APP_TITLE || '软体工厂管理系统' // 网页标题
...
module.exports = {
  ...
  // 例如 https://www.mx.vip/。如果应用被部署在一个子路径上，你就需要用这个选项指定这个子路径。例如，如果你的应用被部署在 https://www.mx.vip/admin/，则设置 baseUrl 为 /admin/。
